...
user_id varchar PRIMARY KEY, first_name varchar, 
...
start_time timestamp NOT NULL REFERENCES 
time(start_time) ON DELETE CASCADE ON UPDATE CASCADE ,
...
user_agent ) VALUES (%s,%s,%s,%s,%s,%s8,%s,%s) 
